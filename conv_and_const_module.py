...
conv_erg_to_GeV = 624.151    # conversion factor from [erg] to [GeV]

''' constants '''
alpha = 1 / 137
hbar_GeV = 6.582e-25        # GeV*s
c = 2.998e+10               # speed of light, in [cm/s]
hbar_J = 1.05*10**(-34)     # J*s
me = 0.511e-3               # GeV  (rest mass energy, m_e * c^2)
k = 8.617e-14               # GeV / K
h = 4.13*10**(-15)          # eV
r0 = 2e-13                  # cm - electron classical radius
